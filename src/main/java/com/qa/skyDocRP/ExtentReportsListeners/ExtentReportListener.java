package com.qa.skyDocRP.ExtentReportsListeners;
...
public class ExtentReportListener {
	...
	public static ExtentReports setUp() {
		...
		report = new ExtentSparkReporter(System.getProperty("user.dir") + "/Extent_report/SkyDoc Automation Test Report.html");
