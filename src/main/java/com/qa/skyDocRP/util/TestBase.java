...
import com.qa.skyDocRP.ExtentReportsListeners.ExtentReportListener;
...
public class TestBase extends ExtentReportListener {
	...
	public TestBase() {
		try {
			prop = new Properties();
			FileInputStream fis = new FileInputStream("F:\\Selenium\\SkyDocAutomation_DevProdRP\\src\\main\\java\\com\\qa\\skyDocRP\\config\\config.properties");
			prop.load(fis);
		} catch(IOException e) {
			e.getMessage();
		}
